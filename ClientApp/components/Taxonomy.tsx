...
class App extends React.Component<AppProps, any> {
    ...
    componentWillReceiveProps(nextProps: AppProps) {
        ...
        if (nextProps.taxonomy.hasDeleted === true && this.props.taxonomy.hasDeleted === false)
        {
            ...
            return {...item, 
                action: 
                    <div>
                        ...
                        {' '}
                        <button className='btn btn-danger btn-xs' onClick={()=> { if (item.id !== undefined) this.props.taxonomyActions.delete(item.id)}}><i className='glyphicon glyphicon-trash'/></button>
                    </div>
            }});
